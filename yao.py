...
def encrypt(key, data):
    ...
    Args:
        key: A valid pair (key,iv) for decryption (key must be 32 bytes, iv only 16).
        data: The (unpadded) data to encrypt.

    Returns:
        The encrypted (padded) message as a byte stream.
    """
...
class GarbledCircuit:
    ...
    def _gen_keys(self):
        ...
        for wire in self.wires:
            ...
            self.keys[wire] = ((os.urandom(32), os.urandom(16)), (os.urandom(32), os.urandom(16)))
